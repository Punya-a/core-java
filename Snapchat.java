class Snapchat {
    ...
    public static String createAccount (long phoneNumber,String email,String psw ,String fullName){
...
public static boolean validateRegisterFields (long phoneNumber,String email,String psw ,String fullName){
